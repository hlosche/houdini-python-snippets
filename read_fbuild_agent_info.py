...
geo.addArrayAttrib(hou.attribType.Point, "pca_channel_names",
hou.attribData.String, 1)
geo.addArrayAttrib(hou.attribType.Point, "pca_variation_weights",
hou.attribData.Float,  1)
geo.addArrayAttrib(hou.attribType.Point, "pca_tag_layers",
hou.attribData.String, 1)
